    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto flex justify-between fixed z-10 h-16 bg-white px-4 rounded-lg shadow-sm w-[90vw]">
            <div class="flex" >
                ...
                <x-nav-link :href="route('chirps.latest')" :active="request()->routeIs('chirps.latest')" style="color:#26A7DE;">
                        {{ __('Recent Chirps') }}
                </x-nav-link>
                <x-nav-link :href="route('user.index')" :active="request()->routeIs('user.index')" style="color:#26A7DE;">
                    {{ __('All Chirpers') }}
                </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150" style="background-color:#26A7DE;color:white;">
                            @auth
